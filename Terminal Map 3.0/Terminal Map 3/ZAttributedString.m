...
- (void)replaceCharactersInRange:(NSRange)range withString:(NSString *)str {
	[self replaceCharactersInRange:range withAttributedString:[[ZAttributedString alloc] initWithString:str] ];
}
...
+ (id)attributeRunWithIndex:(NSUInteger)idx attributes:(NSDictionary *)attrs {
	return [[self alloc] initWithIndex:idx attributes:attrs];
}
